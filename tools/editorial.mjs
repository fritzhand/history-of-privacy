...
export default function editorial(H) {
  ...
  const scrollSteps = [
    ...
    { eventId: 'netherlands-population-register-lentz-1941', headline: 'A model register, in the wrong hands',
      chips: T('The occupier'), zoom: 5 },
    // Rights & Records
    { eventId: 'udhr-article-12-privacy-1948', headline: 'Privacy becomes a human right',
      media: ['eleanor-roosevelt-udhr-poster-1949', 'palais-de-chaillot-un-general-assembly-1951'], chips: T('An international declaration'), zoom: 5 },
    ...
    { eventId: 'cjeu-schrems-i-safe-harbour-invalid-2015', headline: 'One Facebook user topples a transatlantic deal',
    ...
    { eventId: 'sephora-ccpa-settlement-global-privacy-control-2022', headline: 'Ignoring the signal: part of a $1.2 million settlement',
      chips: T('The regulator enforces the person\'s signal'), zoom: 5 },
    { eventId: 'chatgpt-research-preview-2022', headline: 'A free assistant, open to the public',
    ...
    { eventId: 'myterms-public-launch-london-2026', headline: 'MyTerms launches, pitched at cookie notices and agents',
  ...
  const essay = {
    ...
    paragraphs: [
      ...
      para('Every culture draws the line somewhere', [
        ...
        ['Some of the oldest rules are about relationships and homes: the Hippocratic Oath binds the physician to keep secret what he sees and hears in patients’ lives that ought not to be spoken of;', 'hippocratic-oath-confidentiality'],
      ...
      para('From the wall to the right', [
        ...
        ['Words travelled with the law. Japanese uses the loanword puraibashii, which — according to Masao Horibe, then chairman of Japan’s Personal Information Protection Commission — came into wide use owing partly to a Tokyo court’s 1964 ruling, the first to recognise privacy as a legally protected right in Japan;', 'japan-puraibashii-1964'],
      ...
      para('From the house to the record', [
        ...
        ['in 2015 Shoshana Zuboff set out “surveillance capitalism” — a term she had first used the year before — as a logic of accumulation whose architecture produces a new power, “Big Other”, made of mechanisms of extraction and control that “effectively exile persons from their own behavior”.', 'zuboff-2015-surveillance-capitalism'],
      ]),
      ...
      para('Consent, its critics — and terms the person proffers', [
        ['What the law settled on, online, was consent. Solove named the model “privacy self-management” — rights to notice, access and consent, little changed since the 1970s — and argued that it does not give people meaningful control, because of people’s cognitive limits and because there are too many data collectors to manage one by one.', 'solove-2013-privacy-self-management'],
        ['Nissenbaum named its bind the “transparency paradox”: detailed notices go unread, simple ones leave out what matters.', 'nissenbaum-2011-transparency-paradox'],
        ['Reading the privacy policies of the sites one American visits would take about 244 hours a year — some 40 minutes a day — researchers at Carnegie Mellon estimated in 2008 (their conclusion says 201; their own tables give 244).', ['mcdonald-cranor-hours-per-year-reading-privacy-policies', 'mcdonald-cranor-2008-201-hours']],
  ...
  const flip = {
    steps: [
      ...
      { icon: 'agreement', kicker: 'Voice 4 · The person proffers', title: 'Your terms; both keep the record',
        ...
        source: [...src([H.obj('myterms', 'standard').sources, H.item('myterms', 'mechanics', 'records-both-sides').sources, H.item('myterms', 'mechanics', 'choice-not-negotiation').sources])
          .filter(s => s.verificationStatus === 'CONFIRMED' && /standards\.ieee\.org\/ieee\/7012|cl\. 5\.(2\.4|4\.4) /.test(`${s.url} ${s.title}`)),
          withQuote(lineageRec('ieee-7012-2025').sources, 'small roster')] },
    ],
  ...
  const getSeries = (() => {
    ...
    return {
      ...
      pairNote: 'Read in full, 7002 gives the person no part in setting terms. It expects data subjects to make rights requests, which the organisation must be ready to answer; where it names the parties to an agreement or contract, they are vendors, suppliers, partners, contractors and other third parties, or people inside the organisation — never the person; and it mentions consent once, to note that some jurisdictions do not recognise employee consent as valid. It does not claim to be about who writes the terms; 7012 is.',
      pairNoteSource: src([withQuote(r7002, 'requests are recieved relating to data subject rights'), withQuote(r7002, 'data sharing agreements and contracts with vendors'), withQuote(r7002, 'do not recognize employee consent')]),
      coda: 'Neither text cites the other: 7012 cites no other standard in the series, and 7002 cites none of the 7000 series — its reading runs to NIST, ISO/IEC, the regulators\' impact-assessment guides and the Fair Information Practices “first developed by the US Government in 1973”, with a footnote link to the 1973 report this history\'s data-protection chapter quotes. No public IEEE statement this study found says that one builds on or complements the other; the clearest link the texts show is a person, John Wunderlich, vice chair of the 7002 working group and a member of 7012\'s (two balloters, Werner Hoelzl and Piotr Karocki, also voted on both). The two come from different parts of IEEE — 7002 from the Computer Society\'s Personal Data Privacy Working Group, 7012 from the Machine Readable Privacy Terms working group of the Society on Social Implications of Technology — though IEEE SA\'s 2018 statement lists both among the projects of its 7000 series, and says of P7012 that privacy policies “are one-sided and need no agreement”. When 7012 was published in January 2026 it was the newest of the twelve; IEEE 7014.1, on emulated empathy in general-purpose AI “partners”, followed in June 2026.',
      codaSource: src([withQuote(rel.sources, 'There are no normative references in this standard'), withQuote(rel.sources, 'There are no normative references for this draft standard'),
        withQuote(rel.hew1973.sources, 'First developed by the US Government in 1973'), withQuote(rel.sources, 'John Wunderlich, Vice Chair'), withQuote(rel.sources, 'Machine Readable Privacy Terms Working Group had the following membership'), withQuote(rel.sources, 'balloting group voted on this standard'),
